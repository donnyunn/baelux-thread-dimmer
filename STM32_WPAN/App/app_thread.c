...
void APP_THREAD_Init( void )
{
  ...
  //  */
  // APPD_TracesConfig.thread_config = 0x0;
...
void APP_THREAD_SW1_Pressed(void)
{
  WorkButtonCommand(NULL, BUTTON_MODE);
}
void APP_THREAD_SW2_Pressed(void)
{
...
void APP_THREAD_Encoder_Down(void)
{
  WorkButtonCommand(NULL, BUTTON_STEPDOWN);
}
void APP_THREAD_Encoder_Up(void)
{
  WorkButtonCommand(NULL, BUTTON_STEPUP);
}
