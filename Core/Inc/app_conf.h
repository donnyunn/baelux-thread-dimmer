...
#define TASK_SW1      (1U << CFG_TASK_SW1)
#define TASK_SW2      (1U << CFG_TASK_SW2)
#define TASK_SW3      (1U << CFG_TASK_SW3)
#define TASK_SW4      (1U << CFG_TASK_SW4)
...
#define TASK_WAKEUP_ENCODER  (1U << CFG_TASK_WAKEUP_ENCODER)
